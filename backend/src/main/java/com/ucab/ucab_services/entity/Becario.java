...
/**
 * Mapea la tabla Becario. Especialización de Estudiante (misma
 * lógica que Preparador: PK también es FK hacia Estudiante).
 */
@Entity
@Table(name = "becario")
@Getter
...
public class Becario {
    ...
    private String tipoBeca; // 'Ayuda_Economica', 'Excelencia', 'Comedor'
